...
/*
======================================================================
   NN_PGE_CORRECTION — ML-based Pressure Gradient Error correction.
   Not compatible with PGF_BASIC_JACOBIAN (no Density Jacobian call).
                   (TODO sm-loop)
======================================================================
*/
#if defined NN_PGE_CORRECTION && defined PGF_BASIC_JACOBIAN
# undef NN_PGE_CORRECTION
